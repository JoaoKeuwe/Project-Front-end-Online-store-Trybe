...
export async function getNameProducts(productId) {
  const NAME_PRODUCT = `https://api.mercadolibre.com/items/${productId}`;
  const productName = await fetch(NAME_PRODUCT);
